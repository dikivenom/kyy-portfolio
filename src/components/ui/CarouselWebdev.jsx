...
const IMAGES = [
  ...
  { src: STATIC_IMG, detail: 'Routing', title: 'STATIC ROUTING CONFIGURATION' },
  { src: DYNAMIC_IMG, detail: 'Routing', title: 'DYNAMIC ROUTING OSPF' },
];

export default function CarouselWebdev() {
  return (
    <div className='w-full flex-col items-center gap-4 flex'>
      <h1 className='text-lg font-gothicexpanded bg-[#f692c0] px-3 neu mt-7 sm:mt-0'>WEB PROJECTS</h1>
              ...
              <div className='p-[10px]'>
                <Card className='shadow-none p-0 bg-main text-main-foreground neu relative overflow-hidden'>
                  <CardContent className='flex flex-col p-0 h-full'>
                    ...
                    <CardFooter className='h-[15%] p-1 pb-3 bg-[#38b042]/90 border-t border-border flex items-center justify-evenly'>
                      <span className='text-sm font-rocknroll-one items-center  text-white pl-2 '>
                        {item.title}
                      </span>
                      <span className='text-sm font-rocknroll-one rounded-sm bg-[#f692c0]  text-black items-center text-muted neu px-7 py-2 mr-4'>View</span>
                    </CardFooter>
                  </CardContent>
                </Card>
              </div>
